...
PYBIND11_MODULE(generator, m) {
  m.doc() =
      "Trustedflow Attestation Generator is a library for generating "
      "attestation report on different tee platforms";

  // bind AttestationGenerator class
  py::class_<trustedflow::attestation::generation::AttestationGenerator>(
      m, "AttestationGenerator")
      .def("generate_report_json",
           &trustedflow::attestation::generation::AttestationGenerator::
               GenerateReportJson);
