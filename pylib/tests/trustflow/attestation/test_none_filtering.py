...
class TestJsonNoneFiltering(unittest.TestCase):
    ...
    def test_attestation_attribute_none_filtering(self):
        ...
        none_fields = [
            "hex_platform_hw_version", "hex_platform_sw_version", 
            "hex_secure_flags", "hex_platform_measurement",
            "hex_boot_measurement", "str_tee_name", "str_tee_identity",
            "hex_ta_dyn_measurement", "hex_signer", "hex_prod_id",
            "str_min_isvsvn", "bool_debug_disabled", "hex_user_data",
            "hex_hash_or_pem_pubkey", "hex_nonce", "hex_spid", "str_verified_time"
        ]
    ...
    def test_round_trip_with_none_values(self):
        ...
        self.assertIsNone(reconstructed.report_params)  # Should be None since it was filtered out
