...
#include "trustedflow/attestation/generation/sgx2/sgx2_generator.h"
...
Sgx2AttestationGenerator::GenerateReport(
  ...
  YACL_ENFORCE(
      gen_params.report_type() ==
              trustedflow::attestation::ReportType::kReportTypeBgcheck ||
          gen_params.report_type() ==
              trustedflow::attestation::ReportType::kReportTypePassport,
  ...
  if (gen_params.report_type() ==
    ...
    trustedflow::attestation::collateral::GetIntelCollateral(quote, quote_size,
                                                             collateral);
